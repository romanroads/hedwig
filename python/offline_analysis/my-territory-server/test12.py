...
def main():
    #in_path = "F:\\项目文档\\绛门\\陆领项目\\CAERI_Return\\1 广州沈海高速(初采)_2h38min2s\\1_纠偏_剪切_mvd.csv"
    ...
    o_x_offset = x_arr[-1] - x_arr[0]
    print('Original Offset：{}'.format(o_x_offset))

    l_x_offset = new_x_arr[-1] - new_x_arr[0]
    print('Lowess Offset：{}'.format(l_x_offset))
